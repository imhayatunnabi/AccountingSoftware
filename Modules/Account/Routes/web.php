...
Route::prefix('account')->name('account.')->group(function() {
    ...
    Route::prefix('/transaction-type')->name('transaction.type.')->group(function(){
        ...
        Route::put('/edit-details/{id}',[TransactionTypeController::class,'editDetails'])->name('editDetails');
